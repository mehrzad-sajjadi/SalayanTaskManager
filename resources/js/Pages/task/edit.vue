<template>
    ...
    <AuthenticatedLayout>
        ...
        >
            ...
            >
                <p class="px-4 m-2 text-xl">ویرایش تسک</p>
            </div>
            <div class="flex flex-col justify-between">
                <div>
                    <div class="mb-5 py-2 px-2 w-full">
                        ...
                        <label
                            class="block mt-5 mb-2 text-lg font-medium text-gray-900 dark:text-white"
                        >
                            عنوان تسک
                        </label>
                        <input
                ...
                <div class="flex flex-row justify-between mb-4">
                    ...
                    <Link
                        :href="route('user_show', task.user_id)"
                        type="submit"
                        as="button"
...
const form = useForm({
    ...
    deadline: props.task.shamsi_deadline,
    user_id: props.task.user_id,
});

function submit() {
    form.put(route("task_update", props.task.id), {});
}
</script>
